  ...
  <div class="container mx-auto">
    <div class="row">
      <div class="col-12 col-md-6 pr-0 pt-5">
          ...
          <div class="row mt-5 mb-lg-5 row-cols-1 row-cols-lg-2">
            ...
            <div class="col">
              <div class="py-2 my-auto">
                ...
                <p>
                  <a href="tel:<?= get_phone(true); ?>"><?= get_phone(); ?></a><br><span class="smaller">(звонок бесплатный по РФ)</span>
                </p>
              </div>
            </div>
            <div class="col">
        ...
        <?php } else { ?>
          <div class="row mt-5 mb-lg-5 px-3">
            <p class="with-logo subtitle">
              <picture>
                <source srcset="<?= get_with_path('img/logo.webp'); ?>" type="image/webp">
                <img src="<?= get_with_path('img/logo.png'); ?>" alt="">
              </picture> — выдает займы под залог ПТС и авто в <?= set_nowrap(get_declension(get_city(), 1)) ?> до 10 000 000 рублей на срок до 3 лет, со ставкой от 2% в месяц! Миссия нашего автоломбарда - оказывать содействие всем людям оказавшимся в трудном материальном положении. Мы выдаем деньги под залог любых транспортных средств (от легковых автомобилей до грузовиков и спецтехники), кредитная история заемщика не имеет для нас никакого значения, важно лишь то, чтобы автомобиль был на ходу и не находился в залоге или под арестом. Мы поможем получить деньги в течение часа, без справок, поручителей и скрытых комиссий. Автомобиль остается у владельца, без переоформления права собственности.
            </p>
          </div>
        <?php } ?>
      </div>
